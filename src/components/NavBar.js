...
function NavBar (props){
    ...
    const renderBack = () => {
        ...
        return <a href="#home" id={id} ><svg className="nav-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const renderSwitch = (darkMode) => {
        if(darkMode) {
            return <img className="nav-icon" src={moon} id="moon" alt="moon"/>
        }

        else {
            return <img className="nav-icon" src={sun} id="sun" alt="sun"/>
        }
    ...
    const [execute, setExecute] = React.useState(false) 
        ...
        const [
            darkMode,
            setMode
        ] = useStickyState(false, "mode");
        
        const [clicks, setClicks] = React.useState(0) 
        if(!execute) {
            setExecute(true);
            props.cursorColor(!darkMode);
        }
        return (
            <div className="nav">
                {renderBack()}
                ...
                {colorHandler()}
                <div className="menu">
                    <a className="menu-button" href={"#" + projects[0].url}><svg className="menu-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="menu-button" href="#about"><svg className="menu-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="menu-button" href="#contact"><svg className="menu-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="toggle" onClick={() => {
                    ...
                    <div style={{position: 'absolute', zIndex: '101'}}><Darktheme /></div>
